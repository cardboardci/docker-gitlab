...
RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates=20180409 git=1:2.17.1-1ubuntu0.4 openssh-client=1:7.6p1-4 vim-nox=2:8.0.1453-1ubuntu1 jq=1.5+dfsg-2 curl=7.58.0-2ubuntu3 && rm -rf /var/lib/apt/lists/*
